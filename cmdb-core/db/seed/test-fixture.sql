-- ============================================================================
-- CMDB TEST FIXTURE — DEVELOPMENT + INTEGRATION TESTING ONLY
-- ============================================================================
--
-- DO NOT load this file in production. It contains realistic demo data
-- used by the frontend to render every page and by integration tests to
-- exercise real queries.
--
-- Prerequisites (must be loaded first):
--   1. All migrations applied (`migrate up`)
--   2. seed.sql applied (bootstrap tenant + admin + reference data)
--
-- This fixture extends seed.sql with additional users, location hierarchy,
-- racks, assets, alerts, work orders, inventory tasks, BIA assessments,
-- predictions, RCA samples, metrics time-series, etc.
--
...
-- Admin user — password is the bcrypt hash below; dev credentials in docs
INSERT INTO users (id, tenant_id, username, display_name, email, password_hash, status, source) VALUES
    ...
    ('b0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001',
     'sarah.jenkins', 'Sarah Jenkins', 'sarah@example.com',
     '$2b$12$niWDiwVIKZByjN77EhkxpekWRJdznin84cHR7WyyUT/TenYwl78SS',
     'active', 'local'),
    ('b0000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001',
     'mike.chen', 'Mike Chen', 'mike@example.com',
     '$2b$12$niWDiwVIKZByjN77EhkxpekWRJdznin84cHR7WyyUT/TenYwl78SS',
     'active', 'local')
...
INSERT INTO locations (id, tenant_id, name, name_en, slug, level, parent_id, path, metadata, sort_order) VALUES
    ...
    -- ── IDC level (under campuses) ──────────────────────────────
    ('d0000000-0000-0000-0000-000000000020', 'a0000000-0000-0000-0000-000000000001',
     '内湖 IDC-A', 'Neihu IDC-A', 'neihu-idc-a', 'idc', 'd0000000-0000-0000-0000-000000000004', 'tw.north.taipei.neihu.idc_a',
     '{"modules": 2, "racks": 4, "assets": 10, "pue": 1.32, "occupancy": 78, "power": 520, "used": 32, "available": 10, "reserved": 0}', 1),
    ('d0000000-0000-0000-0000-000000000021', 'a0000000-0000-0000-0000-000000000001',
     '内湖 IDC-B', 'Neihu IDC-B', 'neihu-idc-b', 'idc', 'd0000000-0000-0000-0000-000000000004', 'tw.north.taipei.neihu.idc_b',
     '{"modules": 2, "racks": 2, "assets": 3, "pue": 1.38, "occupancy": 60, "power": 220, "used": 12, "available": 8, "reserved": 2}', 2),
    ('d0000000-0000-0000-0000-000000000022', 'a0000000-0000-0000-0000-000000000001',
     '竹科 IDC-A', 'HSIP IDC-A', 'hsip-idc-a', 'idc', 'd0000000-0000-0000-0000-000000000013', 'tw.north.hsinchu.hsip.idc_a',
     '{"modules": 1, "racks": 2, "assets": 4, "pue": 1.42, "occupancy": 58, "power": 280, "used": 10, "available": 6, "reserved": 0}', 1),
    ('d0000000-0000-0000-0000-000000000023', 'a0000000-0000-0000-0000-000000000001',
     '前鎮 IDC-A', 'Qianzhen IDC-A', 'qianzhen-idc-a', 'idc', 'd0000000-0000-0000-0000-000000000014', 'tw.south.kaohsiung.qianzhen.idc_a',
     '{"modules": 1, "racks": 2, "assets": 3, "pue": 1.51, "occupancy": 45, "power": 160, "used": 6, "available": 10, "reserved": 0}', 1),
    -- ── Module level (under IDCs) ───────────────────────────────
    ('d0000000-0000-0000-0000-000000000030', 'a0000000-0000-0000-0000-000000000001',
     '模組 A1', 'Module A1', 'mod-a1', 'module', 'd0000000-0000-0000-0000-000000000020', 'tw.north.taipei.neihu.idc_a.mod_a1',
     '{"racks": 2, "power": 260, "temp_avg": 22.4}', 1),
    ('d0000000-0000-0000-0000-000000000031', 'a0000000-0000-0000-0000-000000000001',
     '模組 A2', 'Module A2', 'mod-a2', 'module', 'd0000000-0000-0000-0000-000000000020', 'tw.north.taipei.neihu.idc_a.mod_a2',
     '{"racks": 2, "power": 260, "temp_avg": 23.1}', 2),
    ('d0000000-0000-0000-0000-000000000032', 'a0000000-0000-0000-0000-000000000001',
     '模組 B1', 'Module B1', 'mod-b1', 'module', 'd0000000-0000-0000-0000-000000000021', 'tw.north.taipei.neihu.idc_b.mod_b1',
     '{"racks": 2, "power": 220, "temp_avg": 21.8}', 1),
    ('d0000000-0000-0000-0000-000000000033', 'a0000000-0000-0000-0000-000000000001',
     '模組 H1', 'Module H1', 'mod-h1', 'module', 'd0000000-0000-0000-0000-000000000022', 'tw.north.hsinchu.hsip.idc_a.mod_h1',
     '{"racks": 2, "power": 280, "temp_avg": 22.0}', 1),
    ('d0000000-0000-0000-0000-000000000034', 'a0000000-0000-0000-0000-000000000001',
     '模組 Q1', 'Module Q1', 'mod-q1', 'module', 'd0000000-0000-0000-0000-000000000023', 'tw.south.kaohsiung.qianzhen.idc_a.mod_q1',
     '{"racks": 2, "power": 160, "temp_avg": 24.2}', 1),
    -- ── Room level (under Modules) ──────────────────────────────
    ('d0000000-0000-0000-0000-000000000040', 'a0000000-0000-0000-0000-000000000001',
     '機房 4A 標準區', 'Room 4A Standard', 'room-4a', 'room', 'd0000000-0000-0000-0000-000000000030', 'tw.north.taipei.neihu.idc_a.mod_a1.room_4a',
     '{"temp": 22.4, "humidity": 44, "power_kw": 130}', 1),
    ('d0000000-0000-0000-0000-000000000041', 'a0000000-0000-0000-0000-000000000001',
     '機房 4B 高密區', 'Room 4B High Dense', 'room-4b', 'room', 'd0000000-0000-0000-0000-000000000030', 'tw.north.taipei.neihu.idc_a.mod_a1.room_4b',
     '{"temp": 23.1, "humidity": 42, "power_kw": 185}', 2),
    ('d0000000-0000-0000-0000-000000000042', 'a0000000-0000-0000-0000-000000000001',
     '機房 5A 網路區', 'Room 5A Network', 'room-5a', 'room', 'd0000000-0000-0000-0000-000000000031', 'tw.north.taipei.neihu.idc_a.mod_a2.room_5a',
     '{"temp": 21.5, "humidity": 46, "power_kw": 95}', 1),
    ('d0000000-0000-0000-0000-000000000043', 'a0000000-0000-0000-0000-000000000001',
     '機房 3A', 'Room 3A', 'room-3a', 'room', 'd0000000-0000-0000-0000-000000000032', 'tw.north.taipei.neihu.idc_b.mod_b1.room_3a',
     '{"temp": 21.8, "humidity": 45, "power_kw": 110}', 1),
    ('d0000000-0000-0000-0000-000000000044', 'a0000000-0000-0000-0000-000000000001',
     '機房 H-1A', 'Room H-1A', 'room-h1a', 'room', 'd0000000-0000-0000-0000-000000000033', 'tw.north.hsinchu.hsip.idc_a.mod_h1.room_h1a',
     '{"temp": 22.0, "humidity": 43, "power_kw": 140}', 1),
    ('d0000000-0000-0000-0000-000000000045', 'a0000000-0000-0000-0000-000000000001',
     '機房 Q-1A', 'Room Q-1A', 'room-q1a', 'room', 'd0000000-0000-0000-0000-000000000034', 'tw.south.kaohsiung.qianzhen.idc_a.mod_q1.room_q1a',
     '{"temp": 24.2, "humidity": 48, "power_kw": 80}', 1)
ON CONFLICT DO NOTHING;
...
INSERT INTO racks (id, tenant_id, location_id, name, row_label, total_u, power_capacity_kw, status) VALUES
    -- Neihu IDC-A / Module A1 / Room 4A (2 racks)
    ('e0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000040', 'RACK-A01', 'A', 42, 10.0, 'active'),
    ('e0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000040', 'RACK-A02', 'A', 42, 10.0, 'active'),
    -- Neihu IDC-A / Module A1 / Room 4B High Dense (2 racks)
    ('e0000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000041', 'RACK-B01', 'B', 42, 12.0, 'active'),
    ('e0000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000041', 'RACK-B02', 'B', 42, 12.0, 'active'),
    -- Neihu IDC-A / Module A2 / Room 5A Network (1 rack)
    ('e0000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000042', 'RACK-C01', 'C', 42, 15.0, 'active'),
    -- Neihu IDC-B / Module B1 / Room 3A (1 rack, maintenance)
    ('e0000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000043', 'RACK-C02', 'C', 42, 15.0, 'maintenance'),
    -- HSIP IDC-A / Module H1 / Room H-1A (2 racks)
    ('e0000000-0000-0000-0000-000000000007', 'a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000044', 'RACK-H01', 'A', 42, 10.0, 'active'),
    ('e0000000-0000-0000-0000-000000000008', 'a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000044', 'RACK-H02', 'A', 42, 10.0, 'active'),
    -- Qianzhen IDC-A / Module Q1 / Room Q-1A (2 racks)
    ('e0000000-0000-0000-0000-000000000009', 'a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000045', 'RACK-Q01', 'A', 42, 8.0, 'active'),
    ('e0000000-0000-0000-0000-000000000010', 'a0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000045', 'RACK-Q02', 'A', 42, 8.0, 'active')
ON CONFLICT DO NOTHING;
...
UPDATE assets SET attributes = '{
  ...
  "os": "Rocky Linux 9.3",
  "primary_ip": "192.0.2.101",
  "mgmt_ip": "198.51.100.101",
...
UPDATE assets SET attributes = '{
  ...
  "network": "4x 25GbE + 2x 100GbE",
  "os": "Rocky Linux 9.3",
  "primary_ip": "192.0.2.102",
  "mgmt_ip": "198.51.100.102",
  "form_factor": "2U Rackmount",
  "warranty_expiry": "2028-03-15",
  "purchase_date": "2025-03-15",
  "uptime_days": 342,
...
UPDATE assets SET attributes = '{
  ...
  "primary_ip": "192.0.2.105",
  "mgmt_ip": "198.51.100.105",
  "form_factor": "2U Rackmount",
...
UPDATE assets SET attributes = '{
  ...
  "primary_ip": "192.0.2.106",
  "mgmt_ip": "198.51.100.106",
  "form_factor": "2U Rackmount",
  "warranty_expiry": "2028-06-01",
  "purchase_date": "2025-06-01",
  "uptime_days": 198,
...
INSERT INTO discovered_assets (tenant_id, source, external_id, hostname, ip_address, raw_data, status, matched_asset_id, diff_details) VALUES
    ('a0000000-0000-0000-0000-000000000001', 'VMware', 'vm-501', 'NEW-APP-SERVER-01', '192.0.2.201',
     '{"cpu": 8, "memory_gb": 32, "os": "Ubuntu 22.04", "cluster": "prod-cluster-1"}',
     'pending', NULL, NULL),
    ('a0000000-0000-0000-0000-000000000001', 'SNMP', 'snmp-sw-301', 'NEW-SWITCH-01', '192.0.2.50',
     '{"ports": 48, "firmware": "IOS-XE 17.9", "model": "Catalyst 9200"}',
     'pending', NULL, NULL),
    ('a0000000-0000-0000-0000-000000000001', 'VMware', 'vm-102', 'SRV-PROD-001', '192.0.2.101',
    ...
    ('a0000000-0000-0000-0000-000000000001', 'manual', 'csv-row-42', 'TEMP-TEST-VM', '203.0.113.42',
     '{"cpu": 2, "memory_gb": 4, "os": "CentOS 7", "note": "test env"}',
     'ignored', NULL, NULL),
    ('a0000000-0000-0000-0000-000000000001', 'VMware', 'vm-205', 'DB-REPLICA-02', '192.0.2.108',
...
-- ============================================================
-- Field Authority definitions for import conflict resolution
-- ============================================================
