...
var SyncLayers = [][]string{
	{"locations", "users", "roles", "alert_rules", "services"},                           // Layer 0: no dependencies
	{"racks", "assets"},                                                                  // Layer 1: depends on locations
	{"rack_slots", "asset_dependencies", "alert_events", "service_assets"},               // Layer 2: depends on racks, assets, services
